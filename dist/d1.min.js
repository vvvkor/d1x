...
/*! d1 dialog */
var n=e(0);t.exports=new function(){"use strict";this.name="dialog",this.dlg=null,this.opt={ccDlg:"dlg rad",customDialog:1,aConfirm:"_confirm",aPrompt:"data-prompt",cBtn:"btn pad",qAlert:"a.alert",qDialog:"a.dialog, input.dialog"},this.init=function(){var t=this;n.plugins.toggle?n.listen("click",(function(i){return t.onClick(i)})):console.error('Module "dialog" requires "toggle"')},this.onClick=function(t){var i=n.closest(t.target,"a, input, button");if(i&&i.matches(this.opt.qAlert+","+this.opt.qDialog))return t.preventDefault(),this.dialog(i)},this.initDlg=function(t,i,e,s,o,a){var r=this;this.dlg||(this.dlg=n.ins("div","",{className:n.opt.cToggle+" "+n.opt.cOff+" "+this.opt.ccDlg},document.body));for(var l,h=this.dlg;l=h.firstChild;)h.removeChild(l);var c=n.ins("div","",{className:"row bg"},h);n.ins("h3",i||"",{className:"fit pad"},c),n.x(c,0,"pad hover col-0");var u=n.ins("div","",{className:"pad"},h);e&&n.ins("div",e,{},u);var p={value:!0};(o||""===o)&&(p=n.ins("input","",{value:o},u));var d=n.ins("p","",{className:"r"},u),f=this.opt.cBtn+" "+(" "==e.substr(0,1)||t&&t.className.match(/-[we]\b/)?"bg-e":"bg-y"),v=this.opt.cBtn+" bg-n",g=n.ins("a",n.attr(t,"data-ok",n.opt.sOk),{href:n.opt.hClose,className:a?v:f},d);s&&(n.ins("a",n.attr(t,"data-cancel",n.opt.sCancel),{href:n.opt.hClose,className:a?f:v},g,a?-1:1),n.ins(""," ",{},g,a?-1:1),g.href=n.opt.hOk,n.b([g],"click",(function(t){t.preventDefault(),s.call(r,p.value)})),p.tagName&&n.b([p],"keyup",(function(t){return 13==t.keyCode?s.call(r,p.value,t):null}))),n.plugins.toggle.toggle(this.dlg,!0)},this.dialog=function(t,i){var e=this;if(!t.form||t.form.checkValidity()){var s=n.attr(t,this.opt.aPrompt),o=n.attr(t,n.opt.aCaption,t.title||s||"!"),a=n.attr(t,"data-reverse"),r=n.attr(t,"data-src");!(r=r?n.q(r):null)&&t.form&&(r=t.form.elements[s]);var l=null,h=t.matches(this.opt.qAlert),c=s?r?r.value:n.get(t,s):null;return this.opt.customDialog?this.initDlg(t,"",o,h?null:function(n){return e.onAnswer(t,i,s,n)},c,a):(l=h?alert(o):s?prompt(o,c):confirm(o),this.onAnswer(t,i,s,l)),this.dlg}t.form.reportValidity()},this.onAnswer=function(t,i,e,s){if(i)i.call(this,t,s);else if(s||""===s){if(t.form){if(!0!==s){var o=t.form.elements[e]||n.ins("input","",{type:"hidden",name:e},t.form);o&&(o.value=s)}t.form.reportValidity()?(n.q('[type="hidden"][name="'+t.name+'"]',t.form)||n.ins("input","",{type:"hidden",name:t.name,value:t.value},t.form),t.form.elements[this.opt.aConfirm]||n.ins("input","",{type:"hidden",name:this.opt.aConfirm,value:1},t.form),t.form.submit()):n.plugins.toggle.unpop()}else if(t.href){var a,r="#"==n.attr(t,"href").substr(0,1),l="_blank"==t.target;if((r||l)&&n.plugins.toggle.unpop(),r)a=t.hash;else{var h={};h[this.opt.aConfirm]=1,!0!==s&&(h[e]=s),a=n.makeUrl(t,h)}"_blank"==t.target?window.open(a,t.target):location.href=a}}else;}}},function(t,i,e){
/*! d1 example plugin */
